...
### Stable and immutable tags
  ...
  - `:11.15-3.7` [*Dockerfile*](https://github.com/eea/eea.docker.postgres/blob/11.10-3.6/postgres/Dockerfile) - PostgreSQL: **11.15** Release: **3.7**
  - `:10.20-3.7` [*Dockerfile*](https://github.com/eea/eea.docker.postgres/blob/10.14-3.6/postgres/Dockerfile) - PostgreSQL: **10.20** Release: **3.7**
  - `:9.6-3.7` [*Dockerfile*](https://github.com/eea/eea.docker.postgres/blob/9.6-3.6/postgres/Dockerfile) - PostgreSQL: **9.6.24** Release: **3.6**
